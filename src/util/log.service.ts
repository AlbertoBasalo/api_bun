...
export function logTrace(message: string, payload: any): void {
  if (logLevel !== "verbose") {
    return;
  }
...
export function logWarning(message: string, payload: any): void {
  if (logLevel === "none") {
    return;
  }
...
export function logError(message: string, payload: any): void {
  if (logLevel === "none") {
    return;
  }
